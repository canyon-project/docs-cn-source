...
按照提示选择配置选项（推荐选择 TypeScript）。

### 3. 编写 Playwright 测试用例
...
### 4. 安装 @canyonjs/playwright 并创建 baseTest.ts
...
安装 [`@canyonjs/playwright`](https://www.npmjs.com/package/@canyonjs/playwright) 包：
